...
## Purpose
Enable automated AI-powered analysis of UI discrepancies between Figma designs and actual implementations using Azure OpenAI (gpt-4.1-mini with vision capabilities). The system detects and categorizes issues by type (LAYOUT_SHIFT, COLOR_MISMATCH, TEXT_DIFFERENCE, ICON_MISMATCH, SIZE_DIFFERENCE) and severity (High, Medium, Low), providing detailed descriptions, suggestions, and bounding box coordinates for each detected issue.
## Requirements
